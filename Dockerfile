...
# docker run -d -p 8080:8080 -e SPRING_DATASOURCE_URL=jdbc:mariadb://host.docker.internal:3306/ordersystem hj0311/ordersystem:latest

# docker 컨테이너 실행시에 볼륨을 설정할때에는 -v 옵션 사용
